            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url("$rootLink/do-update/$list_class->id") }}" enctype="multipart/form-data"
                            method="POST">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6 mt-2">
                                    ...
                                    <select class="form-control " name="category_id" required>
                                        <option value="{{ $list_class->category_id }}">
                                            {{ $list_class->category->title_category }}</option>
                                ...
                                <div class="col-md-6 mt-2">
                                    ...
                                    <input type="text" id="source" name="source" value="{{ $list_class->source }}"
                            ...
                            <div class="form-group mt-4">
                                ...
                                <textarea class="form-control" id="desc" name="desc" rows="4" required>{{ $list_class->desc }}</textarea>
                            </div>
